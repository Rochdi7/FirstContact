<x-app-layout>
    ...
    <x-slot name="toolbar">
        <x-toolbar title="{{__('users.title')}}" :breadcrumb="Breadcrumbs::render('user-show',$user)">
            ...
            <div class="card mb-5 mb-xl-8">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex flex-center flex-column py-5">
                        ...
                        <!--end::Position-->
                        <!--begin::Info-->
                        <div class="fw-bold mb-3">Vérifié et approuvé
                            <span class="ms-2">
                    ...
                    <div class="d-flex flex-stack fs-4 py-3">
                        <div class="fw-bold rotate collapsible" data-bs-toggle="collapse" href="#kt_user_view_details" role="button" aria-expanded="false" aria-controls="kt_user_view_details">Informations
                            <span class="ms-2 rotate-180">
															<i class="ki-outline ki-down fs-3"></i>
														</span></div>
                        <span data-bs-toggle="tooltip" data-bs-trigger="hover" title="Modifier les informations">
															<a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_update_details">Modifier</a>
														</span>
                    </div>
                    <!--end::Details toggle-->
                    ...
                    <div id="kt_user_view_details" class="collapse show">
                        <div class="pb-5 fs-6">
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">APP ID</div>
                            ...
                            <!--begin::Details item-->
                            <!--begin::Details item-->
                            <div class="fw-bold mt-5">Dérnière connexion</div>
                            <div class="text-gray-600">{{$user->last_activity ?? "Jamais connecté"}}</div>
                            <!--begin::Details item-->
                        </div>
                    </div>
                    <!--end::Details content-->
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle table-row-dashed fw-semibold text-gray-600 fs-6 gy-5" id="kt_table_users_logs">
                                    ...
                                    <tr>
                                        ...
                                        <td>POST /v1/invoices/in_4604_7885/payment</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>POST /v1/invoice/in_4001_9483/invalid</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>POST /v1/customer/c_66b9aea3c25a2/not_found</td>
                        ...
                        <div class="card-body py-0">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 text-gray-600 fw-semibold gy-5" id="kt_table_customers_events">
                                ...
                                <tr>
                                    ...
                                    <td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2024, 10:30 am</td>
                                </tr>
                                <tr>
                                    <td class="min-w-400px">
                                ...
                                <tr>
                                    ...
                                    <td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2024, 6:05 pm</td>
                                </tr>
                                <tr>
                                    <td class="min-w-400px">Invoice
                                ...
                                <tr>
                                    <td class="min-w-400px">
                                        <a href="#" class="text-gray-600 text-hover-primary me-1">Sean Bean</a>has made payment to
                                        <a href="#" class="fw-bold text-gray-900 text-hover-primary">#XRS-45670</a></td>
                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2024, 9:23 pm</td>
                                </tr>
                                </tbody>
                            </table>
                            <!--end::Table-->

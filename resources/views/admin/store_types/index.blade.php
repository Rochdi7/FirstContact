<x-app-layout>
    ...
    <x-slot name="toolbar">
        <x-toolbar title="{{__('store_types.title')}}" :breadcrumb="Breadcrumbs::render('store_type')">
            <a href="{{ route('admin.store_types.create') }}" class="btn btn-flex btn-primary h-40px fs-7 fw-bold">{{__('store_types.create')}}</a>
        </x-toolbar>
    </x-slot>
    ...
    <div class="card">
        ...
        @include("admin.store_types.form-search")

        <!--begin::Card body-->
        <div class="card-body">
           @include('admin.store_types.datatable')
        </div>
        <!--end::Card body-->
    </div>
    <!--end::Card-->
    ...
    @push('scripts')
        ...
        <script>
            $(function () {
                ...
                let table = $('#datatable_store_types').DataTable({
                    responsive: true,
                    processing: true,
                    serverSide: true,
                    language: {
                    ...
                    ajax: "{{ route('admin.store_types.index') }}",
                    columns: [

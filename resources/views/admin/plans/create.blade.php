<x-app-layout>
    ...
    <x-slot name="toolbar">
        <x-toolbar title="{{__('plans.title')}}" :breadcrumb="Breadcrumbs::render('plan-create')">
            <a href="{{ route('admin.plans.index') }}" class="btn btn-flex btn-outline btn-color-gray-700 btn-active-color-primary bg-body h-40px fs-7 fw-bold">
                {{ __('buttons.back') }}
            </a>
        </x-toolbar>
    </x-slot>
    ...
    <div class="card">
        ...
        <div class="card-body p-10 p-lg-15">
            ...
            <!--begin::Form-->
            <form method="POST" class="form-plan" action="{{ route("admin.plans.store") }}">
                @csrf

        ...
        <div class="card-title d-flex flex-column flex-md-row">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text" class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('templates.filter.name') }}" data-col-index="0"/>
            </div>
            <!--end::Search Name-->
            ...
            <div class="d-flex align-items-center position-relative ms-md-3 my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text" class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('templates.filter.plan') }}" data-col-index="1"/>
            </div>
            <!--end::Search Plan-->

            <!--begin::Search View Path-->
            <div class="d-flex align-items-center position-relative ms-md-3 my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text" class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('templates.filter.view_path') }}" data-col-index="2"/>
            </div>
            <!--end::Search View Path-->
        </div>
        <!--end::Card title-->

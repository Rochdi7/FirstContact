<form>
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title d-flex flex-column flex-md-row">
            <!--begin::Search First Name-->
            <div class="d-flex align-items-center position-relative my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text" class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('contacts.filter.first_name') }}" data-col-index="0"/>
            </div>
            <!--end::Search First Name-->

            <!--begin::Search Last Name-->
            <div class="d-flex align-items-center position-relative ms-md-3 my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text" class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('contacts.filter.last_name') }}" data-col-index="1"/>
            </div>
            <!--end::Search Last Name-->

            <!--begin::Search Email-->
            <div class="d-flex align-items-center position-relative ms-md-3 my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text" class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('contacts.filter.email') }}" data-col-index="2"/>
            </div>
            <!--end::Search Email-->
        </div>
        <!--end::Card title-->

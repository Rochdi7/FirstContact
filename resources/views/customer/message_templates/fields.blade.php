<div class="row">
    ...
    <div class="form-group col-md-6 mb-7">
        <label class="required fw-semibold fs-6 mb-2">
            {{ __('message_templates.fields.campaign_name') }}
        </label>
        <input type="text" name="name"
            class="form-control form-control-solid {{ $errors->has('name') ? 'is-invalid' : '' }}" required
            placeholder="{{ __('message_templates.fields.campaign_name') }}"
    ...
    <div class="form-group col-md-6 mb-7">
        ...
        <input type="text" name="subject"
            class="form-control form-control-solid {{ $errors->has('subject') ? 'is-invalid' : '' }}" required
...
<div class="row">
    ...
    <div class="form-group col-md-12 mb-7">
        ...
        <textarea name="body" rows="8"
            class="form-control form-control-solid {{ $errors->has('body') ? 'is-invalid' : '' }}" required
    ...
    <div class="text-start pt-10">
        <a href="{{ route('customer.message_templates.index') }}" type="reset" class="btn btn-light me-3"

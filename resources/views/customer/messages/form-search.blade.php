    ...
    <div class="card-header border-0 pt-6">
        ...
        <div class="card-title d-flex flex-column flex-md-row">
            ...
            <div class="d-flex align-items-center position-relative my-1">
                ...
                <input type="text"
                       class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('messages.filter.provider') }}"
                       data-col-index="0"/>
            </div>
            <!--end::Search Provider-->

            <!--begin::Search Message Template-->
            <div class="d-flex align-items-center position-relative ms-md-3 my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text"
                       class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('messages.filter.message_template') }}"
                       data-col-index="1"/>
            </div>
            <!--end::Search Message Template-->

            <!--begin::Search Layout Template-->
            <div class="d-flex align-items-center position-relative ms-md-3 my-1">
                <i class="ki-outline ki-magnifier fs-3 position-absolute ms-5"></i>
                <input type="text"
                       class="form-control form-control-solid datatable-input w-250px ps-13"
                       placeholder="{{ __('messages.filter.layout_template') }}"
                       data-col-index="2"/>
            </div>
            <!--end::Search Layout Template-->
        </div>
        <!--end::Card title-->
